  ...
  return (
    <section className="py-16 md:py-24 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Mission */}
        <div className="bg-gradient-to-br from-primary/10 to-secondary/10 p-8 md:p-12 rounded-2xl border border-primary/20 mb-8">
        ...
        <div className="text-center">
          <Link
            href="/about"
            className="inline-flex items-center space-x-2 bg-white border-2 border-primary text-primary px-8 py-4 rounded-lg font-semibold hover:bg-primary hover:text-white transition-all duration-300"
          >
