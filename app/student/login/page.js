        ...
        <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-2xl border border-gray-200">
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            <div className="text-center">
              ...
              <Link
                ...
                className="block w-full bg-white border-2 border-secondary text-secondary px-6 py-3 rounded-lg font-semibold hover:bg-secondary hover:text-white transition-all duration-300 text-center"
              >
          ...
          <div className="mt-4 text-center">
            <p className="text-xs text-gray-500">
              Are you a teacher?{' '}
              <Link href="/teacher/login" className="text-primary hover:text-primary-dark font-medium">
                Teacher Login
              </Link>
            </p>
          </div>
