export const metadata = {
  ...
  description: 'Communicate with your teachers on Edgen Institute.',
}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 sm:p-8 mb-8">
          ...
          <p className="text-xs sm:text-sm text-yellow-700">
            The messaging system will allow you to communicate directly with your teachers, ask questions, and coordinate sessions.
          </p>
        </div>
