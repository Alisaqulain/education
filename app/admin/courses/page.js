export const metadata = {
  title: 'Manage Courses - Admin - Edgen Institute',
  description: 'Admin panel for managing courses on Edgen Institute.',
}
    ...
    <div className="pt-20 sm:pt-24 md:pt-32 pb-12 sm:pb-16 md:pb-24 min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 sm:p-8 mb-8">
          <p className="text-sm text-yellow-800 font-medium mb-1">Course Management Coming Soon</p>
          <p className="text-xs sm:text-sm text-yellow-700">
            Manage course catalog, approvals, and content from this panel.
          </p>
        </div>
